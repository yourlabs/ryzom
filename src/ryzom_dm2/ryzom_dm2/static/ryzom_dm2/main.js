...
/***/ "../src/ryzom_dm2/ryzom_dm2/static/ryzom_dm2/ryzom_dm2.py":
/*!****************************************************************!*\
  !*** ../src/ryzom_dm2/ryzom_dm2/static/ryzom_dm2/ryzom_dm2.py ***!
  \****************************************************************/
...
// Transcrypt'ed from Python, 2020-03-16 16:50:20
function ryzom_dm2 () {
	...
	(function () {
		...
		var muiSidedrawer = function ($) {
			var $bodyEl = $ ('body');
			var $sidedrawerEl = $ ('#sidedrawer');
			var showSidedrawer = function () {
				var options = dict ({'onclose': (function __lambda__ () {
					return $sidedrawerEl.removeClass ('active').appendTo (document.body);
				})});
				var $overlayEl = $ (mui.overlay ('on', options));
				$sidedrawerEl.appendTo ($overlayEl);
				setTimeout ((function __lambda__ () {
					return $sidedrawerEl.addClass ('active');
				}), 20);
			};
			...
			$titleEls.next ().hide ();
			$titleEls.on ('click', (function __lambda__ () {
				return $ (this).next ().slideToggle (200);
			}));
		};
		jQuery ((function __lambda__ ($) {
			return muiSidedrawer ($);
		}));
		__pragma__ ('<all>')
			__all__.__name__ = __name__;
			__all__.muiSidedrawer = muiSidedrawer;
		__pragma__ ('</all>')
	}) ();
    return __all__;
}
window ['ryzom_dm2'] = ryzom_dm2 ();

//# sourceMappingURL=extra/sourcemap/ryzom_dm2.js.map
...
var muicss = __webpack_require__(/*! muicss/dist/js/mui */ "./node_modules/muicss/dist/js/mui.js");
...
/***/ "./node_modules/muicss/dist/js/mui.js":
/*!********************************************!*\
  !*** ./node_modules/muicss/dist/js/mui.js ***!
  \********************************************/
/*! no static exports found */
...
/* harmony import */ var _src_ryzom_dm2_ryzom_dm2_static_ryzom_dm2_ryzom_dm2_py__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/ryzom_dm2/ryzom_dm2/static/ryzom_dm2/ryzom_dm2.py */ "../src/ryzom_dm2/ryzom_dm2/static/ryzom_dm2/ryzom_dm2.py");
/* harmony import */ var _src_ryzom_dm2_ryzom_dm2_static_ryzom_dm2_ryzom_dm2_py__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_ryzom_dm2_ryzom_dm2_static_ryzom_dm2_ryzom_dm2_py__WEBPACK_IMPORTED_MODULE_0__);
...
/***/ 0:
/*!*****************************************************************!*\
  !*** multi ./index.js ./transcrypt.js ./style.scss ./style.css ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./index.js */"./index.js");
__webpack_require__(/*! ./transcrypt.js */"./transcrypt.js");
